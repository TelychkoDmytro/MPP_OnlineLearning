...
ActiveRecord::Schema[7.0].define(version: 2024_05_28_103522) do
  ...
  create_table "student_attendances", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["schedule_id"], name: "index_student_attendances_on_schedule_id"
  ...
  create_table "student_task_scores", force: :cascade do |t|
    t.integer "student_id", null: false
    t.integer "task_id", null: false
    t.integer "score", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["student_id"], name: "index_student_task_scores_on_student_id"
    t.index ["task_id"], name: "index_student_task_scores_on_task_id"
  end
  ...
  add_foreign_key "student_attendances", "schedules"
  ...
  add_foreign_key "student_task_scores", "students"
  add_foreign_key "student_task_scores", "tasks"
...
ActiveRecord::Schema[7.0].define(version: 2024_05_27_203706) do
  create_table "active_admin_comments", force: :cascade do |t|
    t.string "namespace"
    t.text "body"
    t.string "resource_type"
